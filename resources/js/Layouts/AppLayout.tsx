  ...
  return (
    <div>
      <div className='min-h-screen flex flex-col'>
        ...
        <div className='px-8'>
            <div>
                <div className={show ? clsx('w-full h-screen bg-slate-600/50 fixed top-0 left-0 block') : clsx('hidden')} id="overlay-sidebar" onClick={() => setShow(false)} />
                <nav className={show ? clsx('flex justify-center text-lg bg-violet-400 h-screen fixed top-0 left-0 w-64 z-20 transition-[width] duration-300') : clsx('hidden')}>
